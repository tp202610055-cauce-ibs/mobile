...
class GlossaryApi {
  ...
  const GlossaryApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GlossaryResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GlossaryResult>> apiV1GlossaryGet({ 
    ...
    GlossaryResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GlossaryResult),
      ) as GlossaryResult;
    ...
    return Response<GlossaryResult>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [GlossaryResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GlossaryResult>> apiV1GlossarySearchGet({ 
    String? q,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/glossary/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
