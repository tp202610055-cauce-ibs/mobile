...
class HistoryApi {
  ...
  /// Devuelve el historial unificado del paciente autenticado en un rango de fechas,  ordenado cronológicamente de forma descendente.
  /// 
  ///
  /// Parameters:
