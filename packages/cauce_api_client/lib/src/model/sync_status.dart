...
class SyncStatus extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'SyncPending')
  static const SyncStatus syncPending = _$syncPending;
  @BuiltValueEnumConst(wireName: r'SyncCompleted')
  static const SyncStatus syncCompleted = _$syncCompleted;
