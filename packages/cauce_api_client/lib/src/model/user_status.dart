...
class UserStatus extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'PendingActivation')
  static const UserStatus pendingActivation = _$pendingActivation;
  @BuiltValueEnumConst(wireName: r'Active')
  static const UserStatus active = _$active;
  @BuiltValueEnumConst(wireName: r'Inactive')
  static const UserStatus inactive = _$inactive;
  @BuiltValueEnumConst(wireName: r'Suspended')
  static const UserStatus suspended = _$suspended;
